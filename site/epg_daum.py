...
class EpgDaum(object):
    ...
    def make_epg(cls, channel):
        ...
        try:
            ...
            url = f'https://search.daum.net/search?DA=B3T&w=tot&rtmaxcoll=B3T&q={urllib.parse.quote(channel.daum_id)}'
            from support_site import SiteDaum
            ...
            for t in day_list:
                for tt in t.program_list:
                    ...
                    if tt.daum_title is not None:
                        ...
                        code = ModelEpgContent.append_by_daum(tt.daum_title, tt.daum_id, is_movie=tt.is_movie)
                        if code == None:
